...
* Added CDC DDI 2.6 schemas to the CMV UI ([#311](https://github.com/cessda/cessda.cmv.server/issues/311))

## [4.1.4] - 2026-07-07

### Added

* Added CDC DDI 2.6 profiles to the CMV UI ([#309](https://github.com/cessda/cessda.cmv.server/issues/309))

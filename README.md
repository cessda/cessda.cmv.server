# CESSDA Metadata Validator - Server
...
[![Build Status](https://jenkins.cessda.eu/buildStatus/icon?job=cessda.cmv.server%2Fmain)](https://jenkins.cessda.eu/job/cessda.cmv.server/job/main/)
